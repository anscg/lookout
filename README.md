...
- [Desktop App](https://github.com/hackclub/lookout/releases) - for download on Mac, Windows, and Linux.
  On Linux, `curl -fsSL https://lookout.hackclub.com/install.sh | sh` sets up the right repository for
  apt, dnf, zypper or pacman, so system updates keep it current. See [/docs/linux.md](/docs/linux.md).
